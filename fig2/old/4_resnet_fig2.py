...
sampleloader=torch.utils.data.DataLoader(testset, batch_size=1, shuffle=False, num_workers=4)
...
def standardDeviationVersusLossSGD(std_dev_list, learning_rate, num_epochs, trainloader, testloader, classes, device):
    ...
    with open('new_sample_data.pkl', 'rb') as input:
        ...
        for index, scaling_factor in enumerate(std_dev_list):
            ...
            save_object(histories, 'newhistories5.pkl')
    return histories

histories1 = standardDeviationVersusLossSGD(std_dev_list = [1.15, 1.2, 1.25, 1.3],
                               learning_rate=0.01, 
                               num_epochs=100,
