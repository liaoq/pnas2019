...
sampletrainloader=torch.utils.data.DataLoader(trainset, batch_size=200, shuffle=False, num_workers=1)

sampletestloader=torch.utils.data.DataLoader(testset, batch_size=200, shuffle=False, num_workers=1)
        ...
        for index, scaling_factor in enumerate(std_dev_list):
            ...
            for learning_rate in learning_rates:
                ...
                for epoch in range(iter * num_epochs, (iter+1)*num_epochs):
                    ...
                    torch.save(net.state_dict(), str(scaling_factor)+'.pt')
                iter += 1
            ...
            save_object(histories, 'newhistories1.pkl')
    return histories

histories1 = standardDeviationVersusLossSGD(std_dev_list = [.55, .65],
